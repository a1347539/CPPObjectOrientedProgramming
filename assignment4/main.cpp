...
{
    {
        ...
        for(testCase=1;testCase<=67;testCase++)
        {
            ...
            {
                HashTable* hashTable = new DoubleHashingHashTable(3, stringLength, stringHash);
                hashTable->print();
            ...
            {
                Shop* shop = new Shop(new DoubleHashingHashTable(3, stringLength, stringHash), new DoubleHashingHashTable(3, stringLength, stringHash), new DoubleHashingHashTable(3, stringLength, stringHash));
